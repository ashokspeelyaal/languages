...
SESSION_SECRET = os.environ.get("SESSION_SECRET", "dev-secret-change-me").strip()
DATABASE_PATH = Path(os.environ.get("DATABASE_PATH", str(ROOT / "data" / "b2vocab.db"))).resolve()
