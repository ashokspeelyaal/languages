        ...
        <section class="help-section" id="help-faq">
          ...
          <div class="bilingual" style="margin-top:1rem">
            <div class="nl"><span class="lang-tag">NL</span>
              ...
              Op je eigen server (SQLite + audio-bestanden). Synchroniseert automatisch tussen Mac en iPhone. Op het Overzicht kun je
              een lokale snapshot <em>exporteren</em> als JSON-bestand voor je eigen back-up.
            </div>
            <div class="en"><span class="lang-tag">EN</span>
              <strong>Where is my progress stored?</strong><br>
              On your own server (SQLite + uploaded audio files). Auto-syncs between your Mac and iPhone. From the Dashboard
              you can <em>export</em> a local snapshot as JSON for your own backup.
            </div>
          </div>
